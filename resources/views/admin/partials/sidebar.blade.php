<section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                 <li><a href="{{url('admin/users/create')}}"><i class="fa fa-angle-double-right"></i>Add User</a></li>
                <li><a href="{{url('admin/users/show')}}"><i class="fa fa-angle-double-right"></i>Manage Users</a></li>
            </ul>
        </li>
